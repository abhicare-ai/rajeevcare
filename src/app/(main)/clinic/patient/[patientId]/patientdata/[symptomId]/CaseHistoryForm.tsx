...
export default function CaseHistoryForm({
  ...
  const onSubmit = async (values: DoctorValues) => {
    ...
    startTransition(async () => {
      const res = await doctor(values);
      if (!res) toast.error("Failed to update prescription.");
      else toast.success("Prescription updated successfully!");
    });
  };
              ...
              <Table className="printable-table w-[3000px] overflow-x-auto ">
                <TableHeader className="bg-sidebar">
                  <TableRow>
                    ...
                    <TableHead className="border-r">Physical trauma</TableHead>
                    <TableHead className="border-r">
              ...
              <Table className="printable-table w-[3000px] overflow-x-auto">
                <TableHeader className="bg-sidebar">
                  <TableRow>
                    ...
                    <TableHead className="border-r">Posture and gait</TableHead>
                    <TableHead className="border-r">

...
import SystemFormWithFormPrint from "./SystemFormWithFormPrint";
...
export default function SystemFormWithForm({
  finalData,
  prescitonData,
}: SymtomFormProps) {
  ...
  return (
    <>
      <Tabs defaultValue="1">
        <TabsList>
          <TabsTrigger value="1">Prescriptions</TabsTrigger>
          <TabsTrigger value="2">Form Data</TabsTrigger>
        </TabsList>
        <TabsContent value="1">
      ...
      <SystemFormWithFormPrint
        onclose={() => setOpendialog(false)}
        open={Opendialog}
        finalData={finalData}
        prescitonData={prescitonData}
      />
    </>
  );
}

      ...
      >
        <div
          ...
          className={cn(
            ...
            {
              "focus-within:border-ring focus-within:ring-ring/50 duration-75 focus-within:ring-[3px]":
                activeIndex === -1,

              //   focus-within:border-ring focus-within:ring-ring/50 focus-within:ring-[3px] duration-75
            },
            className,
          )}
        >
